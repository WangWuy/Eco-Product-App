      ...
      children: <Widget>[
        Container(
          ...
          child: Column(
            ...
            children: <Widget>[
              ConstantWidget.getCustomText(widget.title, Colors.black, 1,
                  TextAlign.center, FontWeight.w600, 20),
              SizedBox(
                height: 10,
              ),
              ConstantWidget.getCustomText(widget.descriptions, Colors.black87,
                  2, TextAlign.center, FontWeight.normal, 14),
              SizedBox(
                height: 22,
              ),
              Container(
